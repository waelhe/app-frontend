                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative">
                      ...
                      {category.imageIcon && (
                        <div className={`w-14 h-14 sm:w-16 sm:h-16 rounded-2xl overflow-hidden transition-all duration-200 relative ${isSelected ? 'ring-2 ring-gray-900 ring-offset-2' : 'opacity-90 group-hover:opacity-100 shadow-md'}`}>
                          <Image

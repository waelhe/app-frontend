...
const ServicesStatus = dynamic(() => import('./ServiceStatus'), { loading: () => <LoadingSkeleton /> });
    ...
    groups: [
      {
        ...
        sections: [
          ...
          { id: 'cafes', title: 'مقاهي', titleEn: 'Cafes', icon: Coffee, color: '#8B5A2B', imageIcon: '/images/categories/cafes.webp' },
          { id: 'hotels', title: 'فنادق', titleEn: 'Hotels', icon: Building, color: '#9B59B6', imageIcon: '/images/categories/hotels.webp' },
        ]
      },
      {
        id: 'health',
        ...
        color: '#E31C5F',
        sections: [
          { id: 'doctors', title: 'أطباء', titleEn: 'Doctors', icon: Stethoscope, color: '#E31C5F', imageIcon: '/images/categories/doctors.webp' },
          { id: 'pharmacies', title: 'صيدليات', titleEn: 'Pharmacies', icon: Heart, color: '#00A699', imageIcon: '/images/categories/pharmacies.webp' },
      ...
      },
      {
        ...
        color: '#78716C',
        sections: [
          { id: 'craftsmen', title: 'حرفيين', titleEn: 'Craftsmen', icon: Wrench, color: '#78716C', imageIcon: '/images/categories/craftsmen.webp' },
          { id: 'car-services', title: 'سيارات', titleEn: 'Cars', icon: Car, color: '#428BFF', imageIcon: '/images/categories/cars.webp' },
          { id: 'gas-stations', title: 'بنزين', titleEn: 'Gas', icon: Fuel, color: '#484848', imageIcon: '/images/categories/gas-stations.webp' },
          { id: 'professionals', title: 'مهن حرة', titleEn: 'Professionals', icon: Scale, color: '#6366F1', isNew: true, imageIcon: '/images/categories/professionals.webp' },
        ]
      },
      {
        id: 'shopping',
        ...
        color: '#FC642D',
        sections: [
          { id: 'markets', title: 'أسواق', titleEn: 'Markets', icon: ShoppingCart, color: '#00A699', imageIcon: '/images/categories/markets.webp' },
          { id: 'retail-shops', title: 'محلات', titleEn: 'Shops', icon: ShoppingBag, color: '#FC642D', imageIcon: '/images/categories/retail-shops.webp' },
        ]
      },
      {
        id: 'tourism',
        ...
        color: '#00A699',
        sections: [
          { id: 'places', title: 'سياحة', titleEn: 'Tourism', icon: MapPin, color: '#00A699', imageIcon: '/images/categories/places.webp' },
        ]
      },
    ]
  },
      ...
      <section className="bg-white z-40 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex items-center gap-3 pt-5 pb-1">
            <div className="p-2 rounded-xl" style={{ backgroundColor: '#00A699' + '18' }}>
              <MapPin className="w-5 h-5" style={{ color: '#00A699' }} />
            </div>
            <div>
              ...
              <p className="text-xs text-gray-500">
                {isArabic ? 'اكتشف الخدمات والأماكن في منطقتك' : 'Discover services & places near you'}
              </p>
            </div>
          </div>
          ...
          <div className="relative flex items-center py-3">
            ...
            <div
              ...
              className="flex gap-8 sm:gap-10 overflow-x-auto px-10 py-3"
            ...
            >
              {categories.map((category) => {
                ...
                if (category.isPartHeader) {
                  return (
                    <div
                      key={category.id}
                      className="flex flex-col items-center justify-center min-w-[100px] sm:min-w-[116px] flex-shrink-0 px-2"
                    >
                      {/* خط ملون */}
                      <div
                        className="w-2.5 h-20 rounded-full mb-2"
                ...
                return (
                  <button
                    ...
                    className="flex flex-col items-center gap-3 min-w-[100px] sm:min-w-[116px] group flex-shrink-0"
                  >
                    {/* Image or Icon */}
                    <div className="relative">
                      ...
                      {category.imageIcon && (
                        <div className={`w-[96px] h-[96px] sm:w-[108px] sm:h-[108px] rounded-2xl overflow-hidden transition-all duration-200 relative ${isSelected ? 'ring-2 ring-gray-900 ring-offset-2' : 'opacity-90 group-hover:opacity-100 shadow-md'}`}>
                          <Image
                    ...
                    {/* Label */}
                    <span className={`text-[15px] font-medium whitespace-nowrap transition-colors ${
              ...
              <button
                ...
                className="flex flex-col items-center gap-3 min-w-[100px] sm:min-w-[116px] group flex-shrink-0"
              >
                <div className="w-[96px] h-[96px] sm:w-[108px] sm:h-[108px] rounded-2xl bg-gray-50 flex items-center justify-center group-hover:bg-gray-100 transition-colors">
                  <Grid3X3 className="w-10 h-10 text-gray-400 group-hover:text-gray-600 transition-colors" />
                </div>

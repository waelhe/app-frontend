...
const mockNotifications: Notification[] = [
  ...
  },
  {
    ...
    titleEn: 'Price Drop! 📉',
    descriptionAr: 'انخفض سعر "سيارة تويوتا كامري 2023" التي أضفتها للمفضلة من 95,000 إلى 89,000 ل.س.',
    descriptionEn: 'The price of "Toyota Camry 2023" in your favorites dropped from 95,000 to 89,000 SYP.',
  ...
  },
  {
    ...
    descriptionAr: 'إعلانك "شقة للإيجار في دمشق" لم يعد نشطاً. قم بتجديده الآن للوصول لمزيد من العملاء.',
    descriptionEn: 'Your listing "Apartment for Rent in Damascus" is no longer active. Renew it now to reach more clients.',
    timeAgoAr: 'منذ أسبوع',
